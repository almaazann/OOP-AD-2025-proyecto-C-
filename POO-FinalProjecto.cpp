    ...
    class Cita{
        ...
        Cita(string f, Doctor* d, Paciente* p) : fecha(f), miDoc(d), miPac(p){
            cout << "Cita creada" << endl;
        }

        Cita() : fecha("sin fecha"), miDoc(nullptr), miPac(nullptr){
            cout << "Cita creada" << endl;
        }
    ...
    ostream& operator<<(ostream& os, const Cita& c){
            ...
            if(c.miPac) c.miPac->mostrar_info();
            return os;
        }
            ...
            try{
                switch(opcion){
                    ...
                    case 4:{
                        ...
                        getline(cin,fecha);
                        Cita nuevaCita(fecha,doctorAsignado, &paciente);
